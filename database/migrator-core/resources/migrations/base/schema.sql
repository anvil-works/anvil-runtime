...
CREATE SEQUENCE app_storage_media_object_id_seq;

CREATE TABLE app_storage_media (object_id integer PRIMARY KEY NOT NULL DEFAULT nextval('app_storage_media_object_id_seq'),
                                content_type text,
                                name text,
                                row_id integer,
                                table_id integer,
