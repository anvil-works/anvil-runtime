!function(){if(customElements.get("google-signin-button"))return;let t=`
<style>
...
</button>`;class o extends HTMLElement{constructor(){super();let o=this.attachShadow({mode:"closed"});o.innerHTML=t}}customElements.define("google-signin-button",o);let i=document.createElement("style");i.textContent=`@font-face {
font-family: 'Roboto';
font-style: normal;
font-weight: 500;
font-display: swap;
