...
module.exports = function() {
    ...
    var barelyImplemented = function(kwargs, arglen) {
    	if(arglen != 2 || Object.keys(kwargs).length != 0) {
    		throw new Sk.builtin.NotImplementedError("The 'json' module in Anvil is limited. You may only use a single argument to json.dumps() and json.loads().");
    	}
    };
    ...
    pyMod["dumps"] = PyDefUtils.funcWithKwargs(function(kwargs, pyObj) {
    	...
    	return new Sk.builtin.str(JSON.stringify(Sk.ffi.remapToJs(pyObj)));
    });
