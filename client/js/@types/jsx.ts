...
declare global {
     ...
     // 
     // https://github.com/ryansolid/rxjs-jsx/blob/master/src/jsx.ts
     // 
    ...
    namespace JSX {
        type El = Node | ArrayElement | FunctionElement | string | number | boolean | null | undefined;
        type Refs = { [ref: string]: Node };
        type Element = [El, Refs];
        ...
        interface TextPathSVGAttributes<T>
            extends TextContentElementSVGAttributes<T>,
                ...
                ExternalResourceSVGAttributes,
                StylableSVGAttributes,
                Pick<PresentationSVGAttributes, "alignmentBaseline" | "baselineShift" | "display" | "visibility"> {
