...
import { checkNone, isTrue, pyBool, pyFunc, pyNone, toJs } from "@Sk";
...
interface CheckBoxAnvil {
    elements: { checkbox: HTMLDivElement; label: HTMLElement; input: HTMLInputElement; text: HTMLElement };
}

interface CheckBox extends ClassicComponent<CheckBoxAnvil> {}

const CheckBoxFactory = (pyModule: PyModMap) => {
    ...
    pyModule["CheckBox"] = PyDefUtils.mkComponentCls<CheckBox>(pyModule, "CheckBox", {
        properties: PyDefUtils.assembleGroupProperties<CheckBox>(
                ...
                checked: {
                    ...
                    set(s, e, v) {
                        if (isTrue(s._anvil.props.allow_indeterminate)) {
                            s._anvil.elements.input.indeterminate = v === pyNone;
                        }
                ...
                allow_indeterminate: {
                    ...
                    set(s, e, v) {
                        if (isTrue(v)) {
                            ...
                            s._anvil.elements.input.indeterminate = s._anvil.props.checked === pyNone;
                        } else {
        ...
        locals($loc) {
            $loc["__new__"] = PyDefUtils.mkNew<CheckBox>(ClassicComponent, (self) => {
            ...
            $loc["focus"] = new pyFunc(function focus(self: CheckBox) {
