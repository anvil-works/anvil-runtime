...
export interface ClassicContainer<Anvil extends Record<string, any> = any> extends ClassicComponent<Anvil>, Container {}

const ClassicContainerFactory = (pyModule: PyModMap) => {
    ...
    pyModule["ClassicContainer"] = PyDefUtils.mkComponentCls(pyModule, "ClassicContainer", {
        base: [ClassicComponent, Container],
        ...
        locals($loc) {
            ...
            $loc["__new_deserialized__"] = PyDefUtils.mkNewDeserializedPreservingIdentity(function (
                self: ClassicContainer<{}>,
                pyData: pyDict
            ) {
...
export default ClassicContainerFactory;
